    ...
    return BlocConsumer<AnalitycsCubit, AnalitycsState>(
      ...
      builder: (context, state) {
        ...
        if (state is AnalitycsSuccess) {
          ...
          List<CurrentMonth>? currentMonth = expensesList[0].currentmonth;
          if (expensesList.isNotEmpty) {
            // Sortowanie kategorii według ilości wydatków
            currentMonth!.sort((a, b) => b.categories!.length.compareTo(a.categories!.length));
            List categories = currentMonth.expand((element) => element.categories!).take(5).toList();
            categories.sort((a, b) {
